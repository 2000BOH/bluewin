// Supabase Storage 업로드 — 영선 요청 사진 전용.
// 버킷: 'maintenance-photos' (public, 접근 정책은 Supabase 대시보드에서 설정)
...
export const deleteMaintenancePhoto = async (publicUrl: string): Promise<void> => {
  const supabase = createClient()
