  ...
  return (
    <form action={formAction} className="space-y-3">
      ...
      <section className="rounded-md border bg-background p-3">
        <h3 className="mb-2 text-xs font-semibold text-muted-foreground">① 계약자 기본정보</h3>
      ...
      <section className="rounded-md border bg-muted/30 p-3">
        <h3 className="mb-2 text-xs font-semibold text-muted-foreground">② 연락처 정보</h3>
      ...
      {/* ③ 주소 및 기타 */}
      <section className="rounded-md border bg-background p-3">
        <h3 className="mb-2 text-xs font-semibold text-muted-foreground">③ 주소 및 기타</h3>
